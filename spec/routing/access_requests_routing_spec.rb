...
RSpec.describe AccessRequestsController, type: :routing do
  describe "routing" do
    ...
    it "routes to #edit" do
      expect(:get => "/access_requests/1/edit").to route_to("access_requests#edit", :id => "1")
    end
    ...
    it "routes to #update via PUT" do
      expect(:put => "/access_requests/1").to route_to("access_requests#update", :id => "1")
    end

    it "routes to #update via PATCH" do
      expect(:patch => "/access_requests/1").to route_to("access_requests#update", :id => "1")
    end
